...
function startTheSurvey() {
	...
	var disclosure = document.getElementById("disclosure").remove();
...
function getSurveyCompletionCode() {
	var url="rs?action=getSurveyCompletionCode&pid="+pid;
	fetch(url, onGetSurveyCompletionCode);	
}
function onGetSurveyCompletionCode(resptext) {
	var ele = document.getElementById("survey_comp_code");
	ele.innerHTML=resptext;
}
