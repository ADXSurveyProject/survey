...
public class Participant extends BaseDao {
	...
	public void updateSurveyCompletionCode(String uid,String pid) {
		
		String updatesql = "update participant set survey_comp_code=?  where p_id= ? and survey_comp_code is null";
		executeUpdate(updatesql, new String[]{uid,pid});		
	}
	public List getSurveyCompletionCode(String pid) {
		String sql = "select survey_comp_code from participant where p_id= ?";
		List res = executeFetchSql(sql, new String[]{pid});		
		return res;
	}
